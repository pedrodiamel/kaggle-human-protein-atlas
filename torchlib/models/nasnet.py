...
def nasnetalarge(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        utl.load_state_dict(model.state_dict(), model_zoo.load_url(model_urls['nasnetalarge']))
        return model
...
class NASNetALarge(nn.Module):
    ...
    def __init__(self, num_classes=1001, num_channels=3, stem_filters=96, penultimate_filters=4032, filters_multiplier=2):
        ...
        self.conv0.add_module('conv', nn.Conv2d(in_channels=num_channels, out_channels=self.stem_filters, kernel_size=3, padding=0, stride=2,
                                                bias=False))
